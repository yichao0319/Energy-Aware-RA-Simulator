...
my $output_data_dir = "./plot_dir/data";
my $output_fig_dir = "./plot_dir/figures";

my $gnuplot_trace2scheme_mother = "plot_trace2scheme";
...
# my @schemes = ("EffSnr", "EngTput01", "MaxTput", "SampleRate", "EngTput08", "EngTput06");
...
foreach my $card_type (@card_types) {
    foreach my $constraint (@constraints) {
        ...
        my $out_filename_tput = "static_".$card_type."_".$constraint.".trace2scheme.tput";
        ...
        ##      - generate data file to plot
        $out_filename_tput = "mobile_".$card_type."_".$constraint.".trace2scheme.tput";
